          ...
          <Col sm={12} md={6} lg={4}>
            <Card className="align-items-center">
              ...
              <Card.Body>
                ...
                <p className="pb-0 mb-0">Expertise in building a website using Java, Javascript, and PHP. And the frameworks are Springboot, Vert.x, Laravel, Codeigniter, Node.js, React.js. Keep growing and learning the latest technology</p>
              </Card.Body>
            </Card>
          </Col>
          <Col sm={12} md={6} lg={4}>
